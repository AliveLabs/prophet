...
/* ════════════════════════════════════════════════════════════════════
   ...
   (toTkWeatherIcon, estimateDemand) now live in ./weather-shared — a server-safe
   (non-"use client") module — so the Weather SERVER component (page.tsx) can call
   them without React's "can't invoke a client function from the server" error.
   They're imported above for the client islands below.
   ════════════════════════════════════════════════════════════════════ */
