...
// are live for ALL customers but sit LOWER — they're contextual views that won't apply
// (or be as interesting) to every operator, so they follow the core Today/Competitors/Ask.
const ITEMS = [
