          ...
          recipe: [
            {
              ...
              window: { note: "ongoing" },
              creativeDirection: "show the quality story: the sear, the room, the plating; make the premium feel earned",
          ...
          recipe: [
            {
              ...
              creativeDirection: "a clean shot of the new value plate; name it for search",
