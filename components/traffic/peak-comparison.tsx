...
export default function PeakComparison({ competitors }: Props) {
  ...
  return (
    <div className="space-y-3">
      <div>
        <h3 className="text-sm font-bold text-slate-900">Average Busy Score</h3>
          ...
          <div key={comp.competitor_name} className="rounded-xl border border-slate-200 bg-white px-4 py-3">
            <div className="flex items-center justify-between">
              ...
              <div className="ml-4 flex items-center gap-3">
                ...
                <div className="text-right">
                  <p className="text-[10px] text-slate-400">Avg Peak</p>
                  <p className="text-lg font-bold text-orange-600">{comp.avg_peak}%</p>
                </div>
              </div>
            </div>
