...
export default function LocationWeatherCards({ locations }: Props) {
  ...
  return (
    <div className="space-y-3">
      <h3 className="text-sm font-bold text-foreground">All Locations</h3>
          ...
          >
            <div className="flex items-start justify-between">
              <div className="min-w-0 flex-1">
                <p className="truncate text-sm font-semibold text-foreground">{loc.location_name}</p>
            ...
            <div className="mt-2 flex flex-wrap gap-2 text-[10px] text-muted-foreground">
              ...
              {loc.precipitation_in > 0 && (
                <span className="font-medium text-primary">{loc.precipitation_in}&quot; precip</span>
              )}
            </div>
